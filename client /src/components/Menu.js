...
export class Menu extends Component {
  ...
  let authenticatedMenuItems = [{ name: "Profile", url: "/"}, {name: "Bank Account", url: "/bank_acc"}, {name: "Housing", url: "/housing"}, {name: "Vehicle", url: "/vehicle"}, {name: "Student Loans", url: "/student_loans"}, {name:"Credit Cards", url: "/credit_cards" }, {name: "Logout", url: "/login"}]
